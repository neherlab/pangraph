...
mod tests {
  ...
  fn test_split_matches_simple_case_forward() {
    ...
    let aln = Alignment {
      qry: Hit::new(BlockId(0), 500, (200, 255)),
      reff: Hit::new(BlockId(1), 500, (100, 140)),
      matches: 0,
      length: 0,
      quality: 10,
    ...
    let expected = vec![
      Alignment {
        qry: Hit::new(BlockId(0), 500, (203, 220)),
        reff: Hit::new(BlockId(1), 500, (100, 118)),
        matches: 14,
        length: 21,
        quality: 10,
      ...
      Alignment {
        qry: Hit::new(BlockId(0), 500, (234, 253)),
        reff: Hit::new(BlockId(1), 500, (118, 141)),
        matches: 15,
        length: 27,
        quality: 10,
  ...
  fn test_split_matches_simple_case_reverse() {
    ...
    let aln = Alignment {
      qry: Hit::new(BlockId(0), 500, (200, 256)),
      reff: Hit::new(BlockId(1), 500, (100, 141)),
      matches: 0,
      length: 0,
      quality: 10,
      cigar: parse_cigar_str("3I 6M 3I 3M 4D 5M 14I 7M 3D 4I 5M 5D 3M 3I".replace(' ', "")).unwrap(),
    ...
    let expected = vec![
      Alignment {
        qry: Hit::new(BlockId(0), 500, (236, 253)),
        reff: Hit::new(BlockId(1), 500, (100, 118)),
        matches: 14,
        length: 21,
        quality: 10,
      ...
      Alignment {
        qry: Hit::new(BlockId(0), 500, (203, 222)),
        reff: Hit::new(BlockId(1), 500, (118, 141)),
        matches: 15,
        length: 27,
        quality: 10,
  ...
  fn test_split_matches_with_side_patches_forward() {
    ...
    let aln = Alignment {
      qry: Hit::new(BlockId(0), 257, (200, 257)),
      reff: Hit::new(BlockId(1), 56, (0, 56)),
      matches: 29,
      length: 84,
      quality: 10,
    ...
    let expected = vec![
      Alignment {
        qry: Hit::new(BlockId(0), 257, (203, 220)),
        reff: Hit::new(BlockId(1), 56, (0, 21)),
        matches: 14,
        length: 24,
        quality: 10,
      ...
      Alignment {
        qry: Hit::new(BlockId(0), 257, (234, 257)),
        reff: Hit::new(BlockId(1), 56, (21, 44)),
        matches: 15,
        length: 31,
        quality: 10,
  ...
  fn test_split_matches_with_side_patches_reverse() {
    ...
    let expected = vec![
      Alignment {
        qry: Hit::new(BlockId(0), 257, (237, 257)),
      ...
      Alignment {
        qry: Hit::new(BlockId(0), 257, (204, 223)),
