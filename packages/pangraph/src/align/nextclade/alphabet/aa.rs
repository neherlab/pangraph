use crate::align::nextclade::align::score_matrix_aa::lookup_aa_scoring_matrix;
...
#[repr(u8)]
#[derive(Debug, Clone, Copy, Eq, PartialEq, PartialOrd, Ord, Hash, Serialize, Deserialize, Default)]
pub enum Aa {
  A,
  B,
  C,
