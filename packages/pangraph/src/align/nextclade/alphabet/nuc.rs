use crate::align::nextclade::align::score_matrix_nuc::lookup_nuc_scoring_matrix;
use crate::align::nextclade::alphabet::letter::{Letter, ScoreMatrixLookup};
...
#[repr(u8)]
#[derive(Debug, Clone, Copy, Eq, PartialEq, PartialOrd, Ord, Serialize, Deserialize, Hash, Default)]
pub enum Nuc {
  T,
  A,
  W,
