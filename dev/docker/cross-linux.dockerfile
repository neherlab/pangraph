...
ENV CROSS_DLLTOOL="${CROSS_GCC_DIR}/bin/${CROSS_GCC_TRIPLET}-dlltool"
...
ENV CROSSDLLTOOL="${CROSS_DLLTOOL}"
...
ENV DLLTOOL_${CROSS_COMPILE}="$CROSS_DLLTOOL"
...
ENV CARGO_TARGET_${CROSS_COMPILE_UPPER}_RANLIB="${CROSS_RANLIB}"
ENV CARGO_TARGET_${CROSS_COMPILE_UPPER}_DLLTOOL="${CROSS_DLLTOOL}"
