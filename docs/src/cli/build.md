...
| unbalanced guide-tree | Boolean | n          | not-balanced     | use original guide tree without forcing balancing. Slows down parallelization but more accurate merger order. |
