...
class LineSegments2 extends Mesh {
	...
	computeLineDistances() {
		...
		geometry[setAttributeFn]( 'instanceDistanceStart', new InterleavedBufferAttribute( instanceDistanceBuffer, 1, 0 ) ); // d0

		geometry[setAttributeFn]( 'instanceDistanceEnd', new InterleavedBufferAttribute( instanceDistanceBuffer, 1, 1 ) ); // d1
